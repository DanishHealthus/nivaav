    ...
    <div className="bg-[#EAF1FB] pt-0 md:pt-6 px-8 lg:px-0 ">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-4 relative md:px-8">
        <div className="flex-1 relative">
          ...
          <h2 className="hidden">Advanced Knee Pain Treatment in Delhi NCR & Jaipur</h2>
          <p
          ...
          <Image
            ...
            alt="img"
            className="absolute bottom-28 right-4 translate-y-24 md:hidden translate-x-6"
            height={140}
            width={160}
            loading="eager"
            priority={true}
        ...
        <Image
          ...
          alt="img"
          className="absolute -bottom-20 left-[65%] transform -translate-x-1/2 hidden lg:block"
          width={391}
          height={472}
          loading="eager"
          priority={true}
