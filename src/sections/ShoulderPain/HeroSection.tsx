    ...
    <div className="bg-[#EAF1FB] pt-3 md:pt-6 px-6 lg:px-0 ">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-10 relative md:px-8">
        <div className="flex-1 relative top-6 w-[100%] md:w-[20%]">
          <h1
            className={`${montserratBold.className} text-[#2F438F] text-5xl w-[70%] leading-[60px] hidden md:block`}
          >
            Top Shoulder Pain Treatment in Delhi NCR & Lucknow
          </h1>
          <h1
            className={`${montserratBold.className} text-[#2F438F] text-xl w-[80%] block md:hidden`}
          >
            Top Shoulder Pain Treatment in <br /> Delhi NCR & Lucknow
          </h1>
          <h2 className="hidden">
            Comprehensive Shoulder Pain Treatment in Delhi NCR
          </h2>
          ...
          <Image
            ...
            alt="img"
            className="absolute bottom-4 right-10 translate-y-4 lg:hidden translate-x-10"
            height={190}
            width={190}
            loading="eager"
            priority={true}
