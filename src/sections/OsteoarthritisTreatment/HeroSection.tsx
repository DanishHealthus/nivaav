...
const HeroSection = () => {
  return (
    <div className="bg-[#EAF1FB] pt-3 md:pt-6 px-6 lg:px-0 lg:h-[39rem]">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-10 relative md:px-8">
        <div className="flex-1 relative">
          <h1
            className={`${montserratBold.className} text-[#2F438F] lg:text-5xl text-1xl lg:w-[580px] w-60 lg:mt-36`}
          >
            Best Osteoarthritis <br /> Pain Treatment in <br /> Delhi NCR 
            <br />
          </h1>
          <p
          ...
          <Image
            ...
            alt="img"
            className="absolute bottom-10 right-7.5 translate-y-10 lg:hidden translate-x-10"
            height={160}
            width={220}
            loading="eager"
            priority={true}
