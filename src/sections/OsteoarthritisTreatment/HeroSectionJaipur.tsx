     ...
     <div className="bg-[#EAF1FB] pt-3 md:pt-6 px-6 lg:px-0 ">
              <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-4 relative md:px-8">
                <div className="flex-1 relative mt-0 md:mt-10">
                  ...
                  >
            Best Osteoarthritis <br /> Pain Treatment in <br /> Delhi NCR & Jaipur
          </h1>
          <p
          ...
          <Image
            ...
            alt="img"
            className="absolute bottom-14 right-7 translate-y-10 lg:hidden translate-x-10"
            height={160}
            width={220}
            loading="eager"
            priority={true}
        ...
        <Image
          ...
          alt="img"
          className="absolute -bottom-14 left-[66%] transform -translate-x-1/2 hidden lg:block"
          height={500}
          loading="eager"
          priority={true}
          quality={30}
