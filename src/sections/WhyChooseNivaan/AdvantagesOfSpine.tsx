...
import ComparisonTableSpine from "@/components/ComparisonTableSpine";
...
import { SpineDataType } from "@/app/api/allTypes";
...
const AdvantagesOfSpine: React.FC<WhyChooseNivaanProps> = ({ data, isForm2, formLocation }) => {
  ...
  return (
    <div className="mx-0 md:mx-48">
      ...
      >
        Advantages of Advanced Endoscopic <br/><br/> Spine Procedure
      </h2>
      <ComparisonTableSpine data={data} />
...
export default AdvantagesOfSpine;