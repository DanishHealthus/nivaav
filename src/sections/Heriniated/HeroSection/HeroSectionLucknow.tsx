...
const HeroSectionLucknow: React.FC<HeroSectionProps> = ({ pathName, heading, imgSrc, imgSrcMob, imgStyle }) => {
        ...
        <div className="bg-[#EAF1FB] pt-3 md:pt-6 px-6 lg:px-0 ">
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row lg:gap-10 relative md:px-8">
                <div className="flex-1 relative mt-0 md:mt-10">
                    ...
                    >
                        Effective Back Pain<br /> Treatment in Delhi <br />  NCR & Lucknow
                    </h1>
                    <h2 className="hidden">Effective Back Pain Treatment Solutions in Delhi NCR & Lucnkow</h2>
                    <p
                    ...
                    {/* {isNerveBlockNew || isSciaticaPainNew || isBackPainTreatment ||isBackPainTreamentJaipur? (
              <ul
