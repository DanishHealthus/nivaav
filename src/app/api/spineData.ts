...
import { SpineDataType, IconGridData, Navbar2Type, outcomeBoxType } from "./allTypes";

export const ComparisonTableData: SpineDataType[] = [
  { advantage: "Preserves Healthy Muscles & Ligaments", nivaan: true, other: false },
  { advantage: "Precision-Guided Minimally Invasive Access", nivaan: true, other: false },
  {
    advantage: "Faster Recovery (Days, Not Months)",
    nivaan: true,
    other: false,
  },
  { advantage: "Maintains Natural Spine Stability & Motion", nivaan: true, other: false },
  { advantage: "Minimal Pain & Blood Loss", nivaan: true, other: false },
  { advantage: "Same-Day Discharge Possible", nivaan: true, other: false },
  { advantage: "Cost-Effective with Early Return to Work", nivaan: true, other: false },

];

export const ComparisonTableData2: SpineDataType[] = [
