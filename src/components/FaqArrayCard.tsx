...
const FaqArrayCard = ({ data, isOpen, onToggle }: any) => {
              ...
              <div className="md:pr-8">
                {data.desc ===
                  ...
                  <>
                    ...
                    <ul className={`mt-2 text-[10px] leading-[11.85px] md:text-base whitespace-pre-line ${isDrVideo ? "text-black" : "text-[#2E448F]"} ${rubikLight.className}`}>
                   
                   {data.desc.map((point: string, i: number) => (
                      <li key={i}>• {point}</li>
                    ))}
