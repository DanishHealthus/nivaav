...
import HeroSectionLucknow from "@/sections/Sciatica/HeroSectionLucknow"; 
  ...
  return (
    <>
      ...
      <Clinicleadership isBg={true} doctorData={DoctorDataConsulting} doctorDataMob={DoctorDataConsultingMob} isForm2={true} 
        formLocation="Our-Care-Experts-Sciatica-Form" />
      <Consultingdoctor doctorData={ConsultdoctorLucknow} doctorDataMob={ConsultdoctorLucknow} isForm2={true} 
        formLocation="Our-Care-Experts-Sciatica-Form"/>
...
export default SciaticaPainLucknow;
