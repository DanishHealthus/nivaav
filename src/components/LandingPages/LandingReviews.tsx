...
const LandingReviews = ({ data }: Props) => {
  return (
    <div className='overview-section py-6 space-y-6'>
   
        <div className="bg-white max-w-7xl mx-auto md:px-4">
              ...
              return (
                <SwiperSlide key={index}>
                  <div className="bg-white rounded-[50px] p-6 xl:p-6 2xl:p-8 shadow-[0_3px_20px_rgba(0,0,0,0.1)] my-6 mx-5 lg:mx-4">
                    ...
                    <p className="text-gray-700 text-sm xl:text-base leading-relaxed">{item.commnet}</p>
                  </div>
                </SwiperSlide>
              );
            })}
