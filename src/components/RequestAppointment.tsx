...
const RequestAppointment = ({formLocation}: { formLocation?: string }) => {
  return (
    <div>
      <Navbar2 />
      <Navbar2Mob />
      <div className='hidden md:block'><HeroSection formLocation={`Hero Section ${formLocation}`} /></div>
      <div className='block md:hidden'><HeroSectionMob formLocation={`Hero Section ${formLocation}`} /></div>
