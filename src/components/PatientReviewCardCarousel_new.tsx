...
import PatientReviewCard_new from "./PatientReviewCard_new";

const PatientReviewCardCarousel_new = ({ reviews }: { reviews: Review[] }) => {
          ...
          {reviews?.map((review) => (
            <CarouselItem key={review.id} className="md:basis-1/2 lg:basis-1/3">
              {review.isVideo && review.videoUrl ? (
                ...
                <PatientReviewCard_new review={review}  />
...
export default PatientReviewCardCarousel_new;
