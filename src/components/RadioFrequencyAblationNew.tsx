...
const RadioFrequencyAblationNew = () => {
  ...
  return (
    <>
      ...
      <ThreeColumnHeroBannerForm2
        ...
        heading="Chronic Pain Treatment with Radiofrequency Ablation in Delhi NCR" 
        form={""} 
      ...
      /> */}
      <OurCareExpertsNcrs DoctorData={OurCareExpertsNcr} Heading="Our Care Experts" isForm2={true} formLocation="RadioFrequency Ablation Our Care Experts Form"/>
...
export default RadioFrequencyAblationNew;
