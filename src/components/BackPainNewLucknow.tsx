...
import HeroSectionLucknow from "@/sections/Heriniated/HeroSection/HeroSectionLucknow";

const BackPainNewLucknow = ({pathName, imgStyle}: {pathName: string, imgStyle?: string}) => {
  //const pathName = usePathname();
  // const [showFloatingButton, setShowFloatingButton] = useState(false);
  // const expertsRef = useRef<HTMLDivElement>(null);
  const isBackPainNew = pathName==="/v1/lucknow/back-pain-new";
  ...
  return (
    <>
      ...
      {/* <div ref={expertsRef}> */}
        ...
        <Consultingdoctor isForm2={false} formLocation={"BackPain-our-care-experts"} doctorData={ConsultdoctorLucknow} doctorDataMob={ConsultdoctorLucknow} />
      {/* </div> */}
...
export default BackPainNewLucknow;
