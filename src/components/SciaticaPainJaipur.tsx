  ...
  return (
    <>
      ...
      <FormAd isForm2={true} formLocation="Sciatica-FormAd-Form" />
        ...
        <Consultingdoctor doctorData={ConsultdoctorJaipur} doctorDataMob={ConsultdoctorJaipur} isForm2={true} 
        formLocation="Our-Care-Experts-Sciatica-Form" />
...
export default SciaticaPainJaipur;
