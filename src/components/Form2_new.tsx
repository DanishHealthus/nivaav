      ...
      <div className="flex flex-col gap-0 lg:gap-2 mt-2 lg:mt-4">
        ...
        {location == "mumbai" ?
            <>
              ...
              <div
                className={`bg-[#EAF1FB] border hidden border-solid ${errors.city ? "border-[#CA3F3F]" : "border-[#EAF1FB]"} flex items-center text-xs p-1 px-2 lg:text-sm text-[#888888] rounded-lg mt-2`}
              ...
              <div
                ...
                } flex items-center text-xs p-1 px-2 lg:text-sm text-[#888888] rounded-lg mt-2`}
                onClick={() => inputRef3.current?.focus()}
              >
                <label
      ...
      <div className="flex justify-center mt-0">
        {!phoneNumber ||
          ...
          <button
            ...
            className={`rounded-lg flex gap-2 shadow-sm mt-2 lg:mt-0 px-8 text-white font-semibold p-2  bg-[#DB5115]`}
          >
            Consult Now
          </button>
        ) : (
