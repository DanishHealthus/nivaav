...
import HeroSectionRFALPLucknow from "./ui/HeroSectionRFALPLucknow";
...
const RadioFrequencyAblationLucknow = () => {
  ...
  return (
    <>
      ...
      <Consultingdoctor doctorData={ConsultdoctorLucknow} doctorDataMob={ConsultdoctorLucknow} isForm2={true} formLocation="RadioFrequency Ablation Our Care Experts Form"/>
...
export default RadioFrequencyAblationLucknow;
