  ...
  return (
    ...
    >
      ...
      <input
        ...
        className="px-6 py-4 rounded-3xl outline-none flex-1 border border-solid border-black mb-2 w-full text-xs pr-32"
        value={email}
...
export default SubscribeFormDesktop;