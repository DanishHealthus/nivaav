...
const Form3Hindi = ({
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!firstName || !lastName || !phoneNumber || !selectedTime || !selectedIntensity) {
      setErrors({
        firstName: !firstName ? "कृपया अपना पहला नाम दर्ज करें" : "",
        lastName: !lastName ? "कृपया अपना अंतिम नाम दर्ज करें" : "",
        phoneNumber: !phoneNumber ? "कृपया अपना फ़ोन नंबर दर्ज करें" : "",
        checkbox: selectedValues.length === 0 ? "कृपया कम से कम एक दर्द वाली जगह चुनें" : "",
        time: !selectedTime ? "कृपया अपना पसंदीदा समय चुनें" : "",
        intensity: !selectedIntensity ? "कृपया दर्द की तीव्रता चुनें" : "",
      });
      event.preventDefault();
      return;
    }
  ...
  const handleInputChange = (
    ...
    if (field === "firstName") {
      ...
      if (regex.test(value)) {
        ...
        setErrors((prevErrors) => ({
          ...prevErrors,
          firstName: "कृपया एक मान्य पहला नाम दर्ज करें।",
        }));
      }
    }
    ...
    if (field === "lastName") {
      ...
      if (regex.test(value)) {
        ...
        setErrors((prevErrors) => ({
          ...prevErrors,
          lastName: "कृपया एक मान्य अंतिम नाम दर्ज करें।",
        }));
      }
    }
    ...
    if (field === "phoneNumber") {
      ...
      if (numericValue === "" || /^[6-9]{1}[0-9]{0,9}$/.test(numericValue)) {
        ...
        setErrors((prevErrors) => ({
          ...prevErrors,
          phoneNumber: "कृपया एक मान्य फोन नंबर दर्ज करें",
        }));
      }
    }
    ...
    >
      ...
      <div className="flex flex-col gap-0 lmd:gap-2 mt-2 md:mt-2">
        ...
        <div className="flex flex-col mb-1 mt-3 lg:mt-4 lg:mb-2">
          <div className="flex flex-row gap-0">
            ...
            >
              ...
              >
                <option>शहर का चुनाव करें</option>
                <option value="New Delhi">नई दिल्ली</option>
                <option value="Gurugram">गुरूग्राम</option>
                <option value="Noida">नोएडा</option>
          ...
          {errors.phoneNumber && <p मुंबईclassName="mt-2 text-red-600 text-xs">{errors.phoneNumber}</p>}
        </div>

        <div className="flex flex-col mb-1 mt-3 lg:mt-4 lg:mb-2">
          <h4
            className={`text-sm md:text-base pl-2 text-[#181818] mb-2 lg:mb-2 font-bold ${montserratSemiSemiBold.className}`}
          >
            दर्द का स्थान
            <span
              className={`text-[#CA4A33] font-normal text-sm md:text-xs ${rubikReg.className}`}
            >{` *`}</span>
          </h4>
          <div className="flex flex-row justify-between px-4 items-center">
            {['पीठ', 'गर्दन', 'घुटने', 'अन्य'].map((item, index) => (
        ...
        <div className="flex flex-col mb-1 mt-1 md:mt-3 lg:my-2">
          <h4
            className={`text-sm md:text-base text-[#181818] pl-2 mb-2 lg:mb-2 font-bold ${montserratSemiSemiBold.className}`}
          >
            कॉल बैक करने का सही टाइम
            <span
              className={`text-[#CA4A33] font-normal text-sm md:text-xs ${rubikReg.className}`}
            >{` *`}</span>
          </h4>
          ...
          >
            <select
              ...
              className="outline-none flex-1 p-2 rounded-lg border border-solid border-black w-48 h-[45px] text-sm"
            >
              <option selected="true" value="-Select-">समय का चयन कीजिए *</option>
              <option value="Morning&#x20;&#x28;8AM&#x20;-&#x20;12PM&#x29;">सुबह (8AM - 12PM)</option>
              <option value="Afternoon&#x20;&#x28;12PM&#x20;-&#x20;4PM&#x29;">दोपहर (12PM - 4PM)</option>
              <option value="Evening&#x20;&#x28;4PM&#x20;-&#x20;8PM&#x29;">शाम (4PM - 8PM)</option>
        ...
        <div className="flex flex-col mb-1 mt-1 lg:my-2">
          <h4
            className={`pl-2 text-sm md:text-base text-[#181818] mb-2 lg:mb-2 ${montserratSemiSemiBold.className}`}
          >
            दर्द की तीव्रता
            <span
              className={`text-[#CA4A33] font-normal text-sm md:text-xs ${rubikReg.className}`}
          ...
          <div className="flex flex-row px-2 items-center gap-10">
            <div className="flex flex-col items-center justify-center">
              ...
              <label for="Radio_1" className={`${montserratSemiSemiBold.className} text-[#181818B2] text-xs md:text-sm mt-2`}>हल्का</label>
            </div>
            <div className="flex flex-col items-center justify-center">
              <input type="radio" id="Radio_2" name="Radio" value="Moderate" onChange={(event) => handleInputChange(event, "intensity")} />
              <label for="Radio_2" className={`${montserratSemiSemiBold.className} text-[#181818B2] text-xs md:text-sm mt-2`}>मध्यम</label>
            </div>
            <div className="flex flex-col items-center justify-center">
              <input type="radio" id="Radio_3" name="Radio" value="Severe" onChange={(event) => handleInputChange(event, "intensity")} />
              <label for="Radio_3" className={`${montserratSemiSemiBold.className} text-[#181818B2] text-xs md:text-sm mt-2`}>गंभीर</label>
            </div>
          </div>
