...
const Form2Physio = ({
  ...
  const [errors, setErrors] = useState({ fullName: "", phoneNumber: "", city: "", checkbox: "", common: "" });
  ...
  const handleSubmit = () => {
    let newErrors: { fullName?: string; phoneNumber?: string; city?: string; checkbox?: string; common?: string } = {};
  ...
  return (
    <form
      ...
      className="bg-white w-full min-w-[340px] lg:w-[440px] p-4 rounded-xl relative z-[99] shadow-lg border-[1px] border-[#F4F3ED] md:pb-6"
    >
      ...
      <h2
        className={` ${rubikSemiBold.className} text-center my-0 text-base md:text-[1.5rem] lg:mb-3 text-[#2F438F]`}
      >
        Book Consultation
      </h2>
      {errors.common && (
      ...
      <div className="flex flex-col gap-0 lg:gap-2 mt-2 lg:mt-3">
        <div className="mb-2">
          {errors.fullName && (
            <p className="mt-2 text-[#CA3F3F] text-[0.625rem]">{errors.fullName}</p>
          )}
          <div
            className={`border border-solid ${errors.fullName ? "border-[#CA3F3F]" : "border-[#EAF1FB]"} flex bg-[#EAF1FB] rounded-lg items-center text-xs  px-2 lg:text-sm text-[#888888]`}
            onClick={() => inputRef2.current?.focus()}
          >
            <label className={`${rubikReg.className} text-[10.83px] md:text-[14.53px] py-2 md:py-2 px-1`}>
              Name <em>*</em>
            </label>
            <input
              type="text"
        ...
        <div
          className={`border border-solid ${errors.phoneNumber ? "border-[#CA3F3F]" : "border-[#EAF1FB]"} flex bg-[#EAF1FB] rounded-lg items-center text-xs pl-2 lg:text-sm text-[#888888]`}
        ...
        <div
          className={`bg-[#EAF1FB] border border-solid ${errors.city ? "border-[#CA3F3F]" : "border-[#EAF1FB]"} flex items-center text-xs px-2 lg:text-sm text-[#888888] rounded-lg mt-2`}
          onClick={() => inputRef3.current?.focus()}
        >
          <label className={`${rubikReg.className} ${errors.city ? "text-[#CA3F3F]" : "text-[#888888]"} text-[10.83px] md:text-[14.53px] py-2 md:py-2 px-1`}>Select City*</label>
          <select
            ref={inputRef3}
            name="Dropdown1"
            value={city}
        ...
        <div className="flex flex-col mb-1 mt-1 lg:my-1">
          <h4
            className={`text-[0.813rem] md:text-lg text-[#2F438F] mb-2 lg:mb-2 font-bold text-center ${montserratLightBold.className}`}
          >
      ...
      <div className="flex justify-center mt-1">
        {!phoneNumber ||
          ...
          <button
            ...
            className={`rounded-lg flex gap-2 shadow-sm mt-2 lg:mt-0 px-8 text-white font-semibold p-2 ${isNextPath ? "bg-[#DB5115]" : "bg-[#DB5115]"}`}
          >
            Consult Now
          </button>
        ) : (
          <button
            ...
            type="submit"
            className={`${isNextPath ? 'bg-[#DB5115]' : 'bg-[#DB5115]'} rounded-lg flex gap-2 shadow-sm mt-2 lg:mt-0 px-8 text-white font-semibold p-2`}
          >
            {isLoading ? (
              <>
