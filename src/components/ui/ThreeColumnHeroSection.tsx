    ...
    return (
        <div className="bg-[#EAF1FB] pt-3 md:pt-6 px-8 lg:px-0">
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[2fr_minmax(150px,300px)_2fr] lg:gap-5 relative">
                ...
                <div className={heroImgClassName ? heroImgClassName : defaultClassName}> 
                    {
                        mobileImageSrc && 
                        <Image
                            src={mobileImageSrc}
                            alt="Mobile Image"
                            className="w-auto h-[136.55px] max-w-[148.87px] block lg:hidden pl-2" 
                            height={380}
                            width={300}
                            loading="eager"
                            priority={true}
...
export default ThreeColumnHeroSection;