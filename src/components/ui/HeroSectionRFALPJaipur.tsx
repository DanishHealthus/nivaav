...
const HeroSectionRFALPJaipur = ({ imageSrc, form, heading, subHeading, achievementPoints, showFormHeader, formLocation, isTwoByTwoHeaderMetric,sub_heading }: PropTypes) => {
    return (
...
export default HeroSectionRFALPJaipur;