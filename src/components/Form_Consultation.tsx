...
const Form_Consultation = ({
  ...
  const handleSubmit = async () => {
    ...
    if (allFieldsEmpty || !fullName || !phoneNumber || !city) {
      setErrors({
        ...
        zone: (!zone && location=="mumbai") ? "Please enter your Zone to continue" : "",
  ...
  const handleLoading = () => {
    ...
    if(location == "mumbai"){
      if (fullName && phoneNumber && city && isValid && zone) {
        sendGTMEvent({
          event: "Form_Submit",
          value: {
            "Form Name": formName,
        ...
        {location == "mumbai" ? 
          <>
              ...
              <div
                ...
                } flex hidden items-center text-xs p-1 px-2 lg:text-sm text-[#888888] rounded-lg`}
              ...
              <div
                className={`bg-[#EAF1FB]  border border-solid ${errors.zone ? "border-[#CA3F3F]" : "border-[#EAF1FB]"} flex items-center text-xs p-1 px-2 lg:text-sm text-[#888888] rounded-lg`}
                onClick={() => inputRef3.current?.focus()}
              >
                <label
                  className={`${rubikReg.className} ${
      ...
      <div className="flex justify-center mt-2 md:mt-4">
        {!phoneNumber || !fullName || !city || !isValid ? (
            ...
            onClick={(event) => {
              ...
              if (allFieldsEmpty || !fullName || !phoneNumber || !city) {
                setErrors({
                  ...
                  phoneNumber: !phoneNumber ? "Please enter your Phone Number to continue" : "",
                  city: !city ? "Please enter your City to continue" : "",
                  zone: (!zone && location == "mumbai") ? "Please enter your City to continue" : "",
                  common: allFieldsEmpty ? "Fill In Your Details" : "",
                });
              }
            }}
          ...
          <button
            ...
            type="submit"
            className={`${
              isNextPath ? "bg-[#2F438F]" : "bg-[#DB5115]"
