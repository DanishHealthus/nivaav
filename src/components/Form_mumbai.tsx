...
const Form_mumbai = ({
  ...
  const [errors, setErrors] = useState({fullName: "", phoneNumber: "", city: "", common: "", zone: ""});
  ...
  const handleSubmit = async () => {
    const allFieldsEmpty = !fullName && !phoneNumber && !city && !zone;
  
    if (allFieldsEmpty || !fullName || !phoneNumber || !city || !zone) {
      setErrors({
        ...
        zone: !zone ? "Please enter your Zone to continue" : "",
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center mt-2 md:mt-4">
        {!phoneNumber || !fullName || !city || !zone || !isValid ? (
          <button
            type="button"
            onClick={(event) => {
