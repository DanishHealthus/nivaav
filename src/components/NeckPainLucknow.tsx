    ...
    return (
        <div>
            ...
            <HeroSectionNeckPain 
                ...
                h2Tag="Top Neck Pain Specialists in Delhi NCR & Lucknow" 
            ...
            {/* <div className="bg-[#EAF1FB] " ref={expertsRef}> */}
                ...
                <Consultingdoctor doctorData={ConsultdoctorLucknow} doctorDataMob={ConsultdoctorLucknow} isForm2={false} formLocation="Neck-Pain-Our-Care-Experts"/>
            {/* </div> */}
            <WhyChooseNivaan />
            <TreatmentAtNivaan
...
export default NeckpainLucknow;
