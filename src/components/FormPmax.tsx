...
const defaultFormAction = "https://forms.zohopublic.in/nivaancare/form/NivaanNextjsLandingPagePmaxForm/formperma/ZQNwwH6ZK0h-T8Pz_5P4lbVtCMQUj8XlOVL8KaxgKQ8"
...
const FormPmax = ({
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!firstName || !lastName || !phoneNumber || !selectedTime || !selectedIntensity || !gender || !painMedication) {
      setErrors({
        ...
        painMedication: !painMedication ? "Pain medication information is required." : "",
      });
      return;
    }
    ...
    try {
      if (firstName && lastName && phoneNumber && selectedTime && selectedIntensity && isValid && gender && painMedication) {
        sendGTMEvent({
  ...
  const handleInputChange = (
    ...
    if (field === "pain-medication") {
      setPainMedication(value);
      setErrors((prevErrors) => ({ ...prevErrors, painMedication: "" }));
    }
  };
  ...
  return (
    <form
      action={
        "https://forms.zohopublic.in/nivaancare/form/NivaanNextjsLandingPagePmaxForm/formperma/E6u8oCNg68K8_DpvSyywuz0lIjCABrrsnpJA7B_1-P0/htmlRecords/submit"
      }
    ...
    >
      ...
      <div className="flex flex-col gap-0 lmd:gap-2 mt-2 md:mt-2">
        ...
        <div className="flex flex-col mb-1 mt-3 lg:mt-4 lg:mb-2">
          ...
          {errors.checkbox && <p className="mt-2 text-red-600 text-xs">{errors.checkbox}</p>}
        </div>
        ...
        <div className="flex flex-col mb-1 mt-1 md:mt-3 lg:my-2">
          ...
          {errors.time && <p className="mt-2 text-red-600 text-xs">{errors.time}</p>}
        </div>
        ...
        <div className="flex flex-col mb-1 mt-1 lg:my-2">
          ...
          {errors.intensity && <p className="mt-2 text-red-600 text-xs">{errors.intensity}</p>}
        </div>
        ...
        <div className="flex flex-col mb-1 mt-1 lg:my-2">
          ...
          <div className="flex flex-row px-2 items-center gap-10">
            <div className="flex flex-col items-center justify-center">
              <input type="radio" id="Radio2_1" name="Radio2" value="Male" onChange={(event) => handleInputChange(event, "gender")} />
              <label for="Radio2_1" className={`${montserratSemiSemiBold.className} text-[#181818B2] text-xs md:text-sm mt-2`}>Male</label>
            </div>
            <div className="flex flex-col items-center justify-center">
              <input type="radio" id="Radio2_2" name="Radio2" value="Female" onChange={(event) => handleInputChange(event, "gender")} />
              <label for="Radio2_2" className={`${montserratSemiSemiBold.className} text-[#181818B2] text-xs md:text-sm mt-2`}>Female</label>
            </div>
            <div className="flex flex-col items-center justify-center">
              <input type="radio" id="Radio2_3" name="Radio2" value="Other" onChange={(event) => handleInputChange(event, "gender")} />
              <label for="Radio2_3" className={`${montserratSemiSemiBold.className} text-[#181818B2] text-xs md:text-sm mt-2`}>Other</label>
            </div>
          </div>
          {errors.gender && <p className="mt-2 text-red-600 text-xs">{errors.gender}</p>}
        </div>
        ...
        <div className="flex flex-col mb-1 mt-1 lg:my-2">
          ...
          <div className="flex flex-row px-2 items-center gap-10">
            <div className="flex flex-col items-center justify-center">
              <input type="radio" id="Radio1_1" name="Radio1" value="Yes" onChange={(event) => handleInputChange(event, "pain-medication")} />
              <label for="Radio1_1" className={`${montserratSemiSemiBold.className} text-[#181818B2] text-xs md:text-sm mt-2`}>Yes</label>
            </div>
            <div className="flex flex-col items-center justify-center">
              <input type="radio" id="Radio1_2" name="Radio1" value="No" onChange={(event) => handleInputChange(event, "pain-medication")} />
              <label for="Radio1_2" className={`${montserratSemiSemiBold.className} text-[#181818B2] text-xs md:text-sm mt-2`}>No</label>
            </div>
          </div>
          {errors.painMedication && <p className="mt-2 text-red-600 text-xs">{errors.painMedication}</p>}
        </div>
      ...
      <div className="flex justify-center mt-0">
        ...
        selectedValues.length === 0 ? (
          <button
            ...
            onClick={(event) => {
              event.preventDefault();
              if (!phoneNumber || !firstName || !lastName || !selectedTime || !selectedIntensity || selectedValues.length === 0 || !gender || !painMedication) {
                setErrors({
                  firstName: !firstName ? "First name is required" : "",
                  lastName: !lastName ? "Last name is required" : "",
                  phoneNumber: !phoneNumber ? "Phone number is required" : "",
