...
import HeroSectionJaipur from "@/sections/NerveBlock/HeroSectionJaipur";
...
const NerveblockJaipur = () => {
  ...
  return (
    <>
      ...
      <Consultingdoctor isBg={true} doctorData={ConsultdoctorJaipur} doctorDataMob={ConsultdoctorJaipur}/>
...
export default NerveblockJaipur;
